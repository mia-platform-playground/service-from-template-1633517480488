...
```json
{"name":"service-from-template-1633517480488","status":"OK","version":"0.1.0"}
```
...
```shell
docker pull nexus.mia-platform.eu/console/test-e2e/test-services/service-from-template-1633517480488:latest
set -a
source .env
docker run --name service-from-template-1633517480488 \
  ...
  -p 3000:3000 \
  --detach \
  nexus.mia-platform.eu/console/test-e2e/test-services/service-from-template-1633517480488
```

[nvm]: https://github.com/creationix/nvm
[merge-request]: https://github.com/mia-platform-playground/service-from-template-1633517480488/merge_requests
